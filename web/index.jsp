                        ...
                        <div id="login" class="animate form">
                            <form  action="index.jsp" autocomplete="on"> 
                                ...
                                <p class="keeplogin"> 
									...
									<label for="loginkeeping"><%out.println(msg);%></label>
								</p>
                        ...
                        <div id="register" class="animate form">
                            <form  action="index.jsp" autocomplete="on"> 
                                ...
                                <p> 
                                    ...
                                    <input id="emailsignup" name="txtuser11" required type="email" placeholder="mysupermail@mail.com"/> 
                                </p>
                                <p> 
                                    <label for="passwordsignup" class="youpasswd" data-icon="p">Your password </label>
                                    <input id="passwordsignup" name="txtpass11" required type="password" placeholder="eg. X8df!90EO"/>
                                </p>
                                <p> 
